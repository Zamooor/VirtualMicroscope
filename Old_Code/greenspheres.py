...
def init():
    ...
    theShader = getShader('shader002.vert', 'shader002.frag')
...
def main():
    ...
    while True:
        ...
        if have_joystick:
            ...
            theSphere.Update('translationMatrix',
                             frame.translation)
            theSphere.Update('postRotationMatrix',
                             frame.rotation)
            if autoRotation:
                rotX += 0.005
                rotY += 0.005
        ...
        theSphere.Update('preRotationMatrix', mat)
        ...
        near = max(near, 0.001)
        theSphere.Update('projectionMatrix',
